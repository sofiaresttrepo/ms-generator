export default {
  ...
  generators: {
    ...
    add_new_generator: 'ADD NEW',
    add_new_generator_short: 'NEW',
    ...
    remove_dialog_title: "Do you want to delete the selected Generators??",
  ...
  generator: {
    ...
    update_success: 'Generator has been updated',
    create_success: 'Generator has been created',
    form_validations: {
      name: {
