export default {
  ...
  generators: {
    ...
    add_new_generator: 'Agregar Nueva',
    add_new_generator_short: 'Agregar',
    ...
    remove_dialog_title: "¿Desea eliminar las generators seleccionadas?",
  ...
  generator: {
    generators: 'Generators',
    generator_detail: 'Detalle de la Generator',
    save: 'GUARDAR',
    ...
    update_success: 'Generator ha sido actualizado',
    create_success: 'Generator ha sido creado',
    form_validations: {
      name: {
