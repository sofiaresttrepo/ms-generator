    ...
    return (
        <div>
            <TextField
                ...
                label={T.translate("generator.metadata.createdBy")}
                id="createdBy"
                name="createdBy"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("generator.metadata.createdAt")}
                id="createdAt"
                name="createdAt"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("generator.metadata.updatedBy")}
                id="updatedBy"
                name="updatedBy"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("generator.metadata.updatedAt")}
                id="updatedAt"
                name="updatedAt"
