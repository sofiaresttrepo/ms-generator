...
const CollectionName = 'Generator';
...
class GeneratorDA {
   ...
   */
  static getGenerator$(id, organizationId) {
  ...
  static getGeneratorList$(filter = {}, pagination = {}, sortInput) {
    const collection = mongoDB.db.collection(CollectionName);
  ...
  static getGeneratorSize$(filter = {}) {
    const collection = mongoDB.db.collection(CollectionName);
    const query = this.generateListingQuery(filter);    
  ...
  * @param {*} Generator properties
  */
  static createGenerator$(_id, properties, createdBy) {
  ...
  /**
  * modifies the Generator properties
  * @param {String} id  Generator ID
  * @param {*} Generator properties to update
  */
  static updateGenerator$(_id, properties, updatedBy) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
  ...
  * @param {*} Generator properties to update
  */
  static updateGeneratorFromRecovery$(_id, properties, av) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
  ...
  * @param {*} Generator properties to update
  */
  static replaceGenerator$(_id, properties) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
  ...
  /**
    ...
    * @param {*} _id  Generator ID
  */
  static deleteGenerator$(_id) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
  ...
  /**
    * deletes multiple Generator at once
    * @param {*} _ids  Generator IDs array
  */
  static deleteGenerators$(_ids) {
    const collection = mongoDB.db.collection(CollectionName);
    return defer(() =>
